...
import 'services/firebase_service.dart';
import 'services/location_service.dart';
import 'services/dnd_service.dart'; // Import the DND service
import 'auth/auth_service.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  final FirebaseService _firebaseService = FirebaseService();
  final AuthService auth = AuthService();
  // final DNDService _dndService = DNDService(); // Instance of DNDService
  ...
  void didChangeDependencies() {
    ...
    // _checkDNDStatus(); // Check DND status when the screen is loaded
  }

  // void _checkDNDStatus() async {
  //   bool isDNDActive = await _dndService.isDNDActive();
  //   if (isDNDActive) {
  //     ScaffoldMessenger.of(context).showSnackBar(
  //       const SnackBar(
  //         content: Text("DND mode is active. Notifications may not be received."),
